...
namespace KaizerWald
{
    public partial class Regiment : MonoBehaviour
    {
        ...
        {
            FovGizmosDebug(FieldOfViewTriangle);
...
//╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝
        ...
        //║ ◈◈◈◈◈◈ Gizmos ◈◈◈◈◈◈                                                                                  ║
        //╙────────────────────────────────────────────────────────────────────────────────────────────────────────────╜
        private void FovGizmosDebug(bool showTriangle)
        {
            if (!FieldOfViewDebug /*|| !IsSelected*/) return;
            ...
            DrawFieldOfView(regimentPosition, unit0, unitWidth, showTriangle);
        }
        ...
        private void DrawFieldOfView(float2 regimentPosition, float2 leftStart, float2 rightStart, bool showTriangle)
        {
